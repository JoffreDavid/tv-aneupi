...
interface NoticiaCompletaProps {
    noticia: any; // Recibe el NewsItem desde la página de inicio
    onBack: () => void;
}

export default function NoticiaCompleta({ noticia, onBack }: NoticiaCompletaProps) {
                ...
                <section className="mt-24 pt-12 border-t border-gray-100">
                    ...
                    <div className="bg-white p-6 rounded-3xl mb-12 border border-gray-100 shadow-sm ring-1 ring-gray-50">
                        <textarea 
                            ...
                            placeholder="Escribir un comentario o actualización..."
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="bg-[#003952] text-white text-[9px] font-black px-2 py-0.5 rounded-md">ADMIN</span>
                                                    </div>
